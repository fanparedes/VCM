                                          ...
                                          <div class="form-group">
                                            <label class="col-sm-3 control-label">Nombre de Actividad</label> 
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-8">
														<input maxlength="200" name="data[Activity][nombre]" type="text" placeholder="" class="form-control" value="<?php echo $this->data['Activity']['nombre']; ?>"/>
                                                        </div>
                                                        <div class="col-xs-4">
                                                                <label data-toggle="tooltip" title="Actividad de carácter estratégico y clave para el desarrollo de los objetivos del área e institucionales" >
                                                                    ...
                                                                    &nbsp; Actividad Hito &nbsp;<span class="badge badge-info pull-right" style="font-size:10px;margin-right: 10px;">?</span></label></div>
                                                    </div>
                                                </div>
                                          </div>
                                           ...
                                           <div class="form-group">
                                            <label class="col-sm-3 control-label">Origen de proyecto<br> </label>
                                                 <div class="col-sm-9 controls">
                                                    ...
                                                    <div class="col-xs-5">
                                                        <div class="checkbox">
                                                                <label data-toggle="tooltip" title="Proyecto enmarcado para ser capaz de ser medido y gestionado en sus resultados">
                                                                    ...
                                                                    />
                                                                    &nbsp;Demanda Externa &nbsp;<span class="badge badge-info pull-right" style="font-size:10px;margin-right: 10px;">?</span></label></div>
                                                    </div> 
                                          ...
                                          <div class="form-group">
                                            <label class="col-sm-3 control-label">Nombre del proyecto en el qué se enmarca</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9">
                                                        <input maxlength="200" name="data[Activity][proyectoglobal]" type="text" placeholder="Si se enmarca en un proyecto global" class="form-control" value="<?php echo $this->data['Activity']['proyectoglobal']; ?>"/></div>
                                                    </div>
                                                </div>
                                          </div>
                                          <!--fin de enmarca-->
      ...
      $('#fin_proyecto').val(fecha_mas_anno);
                                          ...
                                          <div class="form-group">
                                            <label class="col-sm-3 control-label">Nombre del responsable de la actividad </label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input maxlength="200" name="data[Activity][responsable]" type="text" placeholder="" class="form-control" value="<?php echo $this->data['Activity']['responsable']; ?>"/></div>
                                                    </div>
                                                </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-sm-3 control-label">Cargo </label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input maxlength="200" name="data[Activity][cargoresponsable]" type="text" placeholder="" class="form-control" value="<?php echo $this->data['Activity']['cargoresponsable']; ?>"/></div>
                                                    </div>
                                                </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="col-sm-3 control-label">Mail</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input maxlength="200" name="data[Activity][mail_responsable]" type="email" id="mail_responsable" placeholder="duoc@duoc.cl" class="form-control" value="<?php echo $this->data['Activity']['mail_responsable']; ?>"/></div>
                                                    </div>
                                                </div>
                                          </div>
                                          <!--convenio-->
  ...
  $('#box_si_pertenece3').fadeIn(500);
                                          ...
                                          > <!--si rellena este input se despliegan los datos de vigencia y alcance-->
                                            <label class="col-sm-3 control-label">Convenio al que pertenece la actividad</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input maxlength="200" id="nombre_convenio" name="data[Activity][convenio_si_no]" type="text" class="form-control" value="<?php echo $this->data['Activity']['convenio_si_no']; ?>"/></div>
                                                    </div>
                                                </div>
                                          </div>
                                                 ...
                                                 <div class="col-sm-9 controls">
                                                    <div class="row">
                                                      ...
                                                      foreach($beginnings as $key_begin => $beginning) { ?>
                                                          ...
                                                          <div class="col-sm-5">
                                                              <div class="checkbox">
                                                                      <label data-toggle="tooltip" title="<?php echo $beginning['Beginning']['descripcion']; ?>">
                                                                          ...
                                                                          />
                                                                          &nbsp;<?php echo $beginning['Beginning']['principio']; ?>&nbsp;<span class="badge badge-info pull-right" style="font-size:10px;">?</span></label>
                                                              </div>
                                                          </div> 
                                                      <?php } ?>
                                            ...
                                            <label class="col-sm-3 control-label">Entidades Relacionadas</label>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-9 controls">
                                                      <div class="row">
                                                          <div class="col-xs-9">
                                                            <textarea maxlength="200" id="ent3" name="data[Activity][detallecontacto1]" rows="3" class="form-control" placeholder="Teléfono y mail"></textarea>
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
                                        ...
                                        <!--PRESUPUESTO-->
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9">
                                                          <input name="data[Activity][costoactividad]" type="number" placeholder="$" class="form-control" value="<?php echo $this->data['Activity']['costoactividad']; ?>"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>    
                                                    ...
                                                    <div class="row">
                                                      ...
                                                      <div class="col-xs-4">
                                                       ...
                                                       <!-- esto debe desplegar sólo al pinchar mixto-->   
                                                            ...
                                                            >Interno
                                                              <input name="data[Activity][financiamientointerno]" id="tot_interno" type="number" placeholder="%" class="form-control solo-numero"   value="<?php echo $this->data['Activity']['financiamientointerno']; ?>"/>
                                                            </div>
                                                            ...
                                                            >Externo
                                                              <input name="data[Activity][financiamientoexterno]" id="tot_externo" type="number" placeholder="%" class="form-control solo-numero"  value="<?php echo $this->data['Activity']['financiamientoexterno']; ?>"/>
                                                            </div>
                                                          </div>
                                                      </div>
                                                    </div> 
                                            ...
                                            >
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                      ...
                                                      <!-- esto debe desplegar sólo al pinchar mixto-->   
                                                      <div class="col-xs-4">
                                                          <input name="data[Activity][direccioncentral]" id="int_dir_central" type="number" class="form-control solo-numero"  value="<?php echo $this->data['Activity']['direccioncentral']; ?>"/>
                                                      </div>
                                                      <div class="col-xs-4">
                                                          <input name="data[Activity][sedesporcentaje]" id="int_sedes" type="number" placeholder="%" class="form-control solo-numero"  value="<?php echo $this->data['Activity']['sedesporcentaje']; ?>"/>
                                                      </div> 
                                                      <div class="col-xs-4">
                                                          <input name="data[Activity][escuelasporcentaje]" id="int_escuelas" type="number" placeholder="%" class="form-control solo-numero"  value="<?php echo $this->data['Activity']['escuelasporcentaje']; ?>"/>
                                                      </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            >
                                                  ...
                                                  <div class="col-sm-9 controls">
                                                    <div class="row">
                                                      ...
                                                      <div class="col-xs-4">
                                                                <input name="data[Activity][fondoconcursable]" id="ext_fon" type="number" placeholder="%" class="form-control solo-numero"  value="<?php echo $this->data['Activity']['fondoconcursable']; ?>"/>
                                                      </div>
                                                      <div class="col-xs-4">
                                                                <input name="data[Activity][entornoproductivo]" id="ext_ento" type="number" placeholder="%" class="form-control solo-numero"  value="<?php echo $this->data['Activity']['entornoproductivo']; ?>"/>
                                                      </div>
                                                      <div class="col-xs-4">
                                                                <input name="data[Activity][entidadesacademicas]" id="ext_enti" type="number" placeholder="%" class="form-control solo-numero"  value="<?php echo $this->data['Activity']['entidadesacademicas']; ?>"/>
                                                      </div>
                                                      <br/><br/><br/>
                                                      <div class="col-xs-4">
                                                          	<div class="checkbox">
                                                      ...
                                                      <br/><br/>
                                                      <div class="col-xs-5">
                                                                <input name="data[Activity][donacionesporcentaje]" id="ext_don" type="number" placeholder="%" class="form-control solo-numero"  value="<?php echo $this->data['Activity']['donacionesporcentaje']; ?>"/>
                                                      </div>
                                                      <br/><br/><br/><br/>
                                                    </div>
                                                  </div>
