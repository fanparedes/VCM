 ...
 */
	Configure::write('Security.salt', 'DYhG93bfgeyJfIxfs2guVoUubWwvniR2G0FgaC9mivcmvcm');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7685930965745345612314542496749683645');
